...
public final class Recipe {
    ...
    public static class Builder {
        ...
        public Builder addIngredient(String ing) { if (ing == null || ing.isBlank()) throw new IllegalArgumentException("ing"); ingredients.add(ing); return this; }
        public Builder addStep(String step) { if (step == null || step.isBlank()) throw new IllegalArgumentException("step"); steps.add(step); return this; }
